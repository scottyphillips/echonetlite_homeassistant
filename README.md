...
| Mitsubishi Electric | MAC-600IF                                    | HomeAirConditioner           | Climate, Sensor, Select          | WiFi Adaptor connected to various HVAC ducted and split systems. See list below.                  |
...
| Mitsubishi Electric | REF-WLAN001               | Refrigerator          | Sensor           |                                                                    | Sharp               | AY-J22H Air Conditioner                        | HomeAirConditioner           | Climate, Sensor, Select          |                                                                                                   |
