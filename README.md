...
| Sharp               | FP-S42Y Air Purifier                           | HomeAirCleaner                 | Fan, Sensor, Select, Switch, Binary Sensor | Seven presets, temperature, humidity, PM2.5, LED, child lock; read-only Plasmacluster. Object model FPS42Y is detected separately from the HW-A04 adapter. |
